...
// 1. RECRÉATION PROPRE DES TABLES (Supprime tous les anciens plats fantômes)
db.exec(`
...
// 2. LA CARTE OFFICIELLE DE L'HÔTEL DES PINS
const carteHotelDesPins = [
  // ==================== MENU À 40 € ====================
  { nom: "Menu à 40 € (Entrée + Plat + Dessert)", categorie: "Menu à 40 €", prix: 40.00 },

  // Choix Entrées Menu 40€
  { nom: "[Menu 40€] Entrée du Jour", categorie: "Menu à 40 €", prix: 0.00 },
  { nom: "[Menu 40€] Saumon fumé maison", categorie: "Menu à 40 €", prix: 0.00 },
  { nom: "[Menu 40€] Foie gras de canard maison, chutney, toast céréales", categorie: "Menu à 40 €", prix: 0.00 },
  { nom: "[Menu 40€] Soupe de poissons du Bassin et ses croûtons", categorie: "Menu à 40 €", prix: 0.00 },
  { nom: "[Menu 40€] Cornet de friture de calamars sauce tartare", categorie: "Menu à 40 €", prix: 0.00 },
  { nom: "[Menu 40€] Assiette de charcuterie", categorie: "Menu à 40 €", prix: 0.00 },
  { nom: "[Menu 40€] Asperges blanches, jambon et vierge de tomate", categorie: "Menu à 40 €", prix: 0.00 },

  // Choix Plats Menu 40€
  { nom: "[Menu 40€] Plat du Jour", categorie: "Menu à 40 €", prix: 0.00 },
  { nom: "[Menu 40€] Dos de maigre, sauce vierge", categorie: "Menu à 40 €", prix: 0.00 },
  { nom: "[Menu 40€] Pavé de cabillaud rôti, petits légumes iodés", categorie: "Menu à 40 €", prix: 0.00 },
  { nom: "[Menu 40€] Pavé de bar à l’huile, risotto de riz noir", categorie: "Menu à 40 €", prix: 0.00 },
  { nom: "[Menu 40€] Blanquette de seiche safranée", categorie: "Menu à 40 €", prix: 0.00 },
  { nom: "[Menu 40€] Carpaccio de bœuf maison basilic et Parmesan", categorie: "Menu à 40 €", prix: 0.00 },
  { nom: "[Menu 40€] Entrecôte de bœuf, échalotes confites", categorie: "Menu à 40 €", prix: 0.00 },
  { nom: "[Menu 40€] Magret de canard, sauce au poivre", categorie: "Menu à 40 €", prix: 0.00 },

  // Choix Desserts Menu 40€
  { nom: "[Menu 40€] Dessert du jour", categorie: "Menu à 40 €", prix: 0.00 },
  { nom: "[Menu 40€] Assiette de fromages", categorie: "Menu à 40 €", prix: 0.00 },
  { nom: "[Menu 40€] Crème brûlée à la vanille de Madagascar", categorie: "Menu à 40 €", prix: 0.00 },
  { nom: "[Menu 40€] Tiramisu au café", categorie: "Menu à 40 €", prix: 0.00 },
  { nom: "[Menu 40€] Café gourmand", categorie: "Menu à 40 €", prix: 0.00 },
  { nom: "[Menu 40€] Fromage blanc fermier et son coulis", categorie: "Menu à 40 €", prix: 0.00 },
  { nom: "[Menu 40€] Mousse au chocolat noir", categorie: "Menu à 40 €", prix: 0.00 },
  { nom: "[Menu 40€] Cheese cake au citron", categorie: "Menu à 40 €", prix: 0.00 },
  { nom: "[Menu 40€] Coupe glacée 2 boules au choix", categorie: "Menu à 40 €", prix: 0.00 },
  ...
  { nom: "Cheese cake au citron", categorie: "Desserts", prix: 8.00 },
...
// 3. INSERTION IMMÉDIATE DES PLATS OFFICIELS
const insertArticle = db.prepare('INSERT INTO articles (nom, categorie, prix, disponible) VALUES (?, ?, ?, 1)');
const chargerCarte = db.transaction((liste) => {
  for (const plat of liste) {
    insertArticle.run(plat.nom, plat.categorie, plat.prix);
  }
});
chargerCarte(carteHotelDesPins);
